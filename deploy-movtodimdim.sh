...
export WEBAPP_NAME="decepticons-api"
export APP_SERVICE_PLAN="planDecepticons"
# Altere a sua região conforme orientação do Professor
export LOCATION="brazilsouth"
export RUNTIME="JAVA:17-java17"
export GITHUB_REPO_NAME="LucasH1303/Sprint3_cloud"
export BRANCH="main"
export APP_INSIGHTS_NAME="ai-decepticons"
...
az webapp config appsettings set \
  ...
  --settings \
    ...
    SPRING_DATASOURCE_URL="jdbc:sqlserver://sqlserver-decepticons.database.windows.net:1433;database=decepticonsdb;user=admsql@sqlserver-decepticons;password={your_password_here};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;"
